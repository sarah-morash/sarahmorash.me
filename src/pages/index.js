      ...
      <section id="two">
        <div className="intro">
          <div>
            ...
            <p>
              This is a personal project I created that has helped me achieve a
              few things:
            </p>
            <ul>
              ...
              <li>
                Have a space to share my opinions on things, and teach others
                lessons I've learned along the way
              </li>
              <li>Show my creativity</li>
              <li>
                Have a space to work with some new technologies (this site is
                using Gatsby JS)
              </li>
            </ul>
          </div>
